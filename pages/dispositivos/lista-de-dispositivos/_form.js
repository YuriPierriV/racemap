...
export function ProfileForm() {
    ...
    const isDeviceValid = !formState.errors.deviceId && watch("deviceId").length === 6;
    ...
    return (
        <Form {...form}>
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
                ...
                />
                <div className={`transition-opacity duration-500 ${isDeviceValid ? "opacity-100 scale-100" : "opacity-0 scale-95 pointer-events-none"}`}>
                    {isDeviceValid && (
