...
const AsidePainel = () => {
  ...
  return (
    <div className="flex h-screen font-roboto">
      <aside className="bg-background text-text dark:bg-dark-background dark:text-dark-text fixed inset-y-2 left-2 z-50 my-2 ml-2 h-[calc(100vh-32px)] w-72 rounded-xl shadow-lg border border-blue-gray-100">
        <div id="Main" className="flex flex-col justify-between h-full">
          <div>
            ...
            <div className="mt-6 flex flex-col justify-start items-center w-full">
              <button
                onClick={() => changeComponent("Painel")}
                className="flex justify-start items-center w-full p-6 space-x-2 focus:outline-none text-text dark:text-dark-text focus:text-primary dark:focus:text-dark-primary rounded hover:bg-gray-200 dark:hover:bg-gray-700 hover:opacity-75"
              >
