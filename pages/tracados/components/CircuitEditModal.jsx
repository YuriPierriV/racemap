...
const CircuitEditModal = ({ circuit, isOpen, onClose, onSave }) => {
  ...
  useEffect(() => {
    if (circuit && isOpen) {
      ...
      console.log('CircuitEditModal - Total de pontos:', circuit.pontos?.length);
  ...
  const handleSave = async () => {
    try {
      setIsSaving(true);
      console.log('CircuitEditModal - Salvando alterações do circuito:', circuit.id);
      ...
      <AlertDialogContent className="max-w-5xl max-h-[90vh] overflow-y-auto">
        <AlertDialogHeader>
          ...
          <AlertDialogDescription className="sr-only">
            Modal para editar as informações do circuito, incluindo nome, descrição, direção e ponto de largada através do mapa interativo.
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            <div>
              <Label htmlFor="edit-name" className="text-base">Nome do Traçado *</Label>
              <Input
                id="edit-name"
                value={editData.nome}
            ...
            <div>
              <Label htmlFor="edit-description" className="text-base">Descrição</Label>
              <Input
                id="edit-description"
            ...
            <div>
              <Label htmlFor="edit-direction" className="text-base">Direção do Traçado *</Label>
              <Select
              ...
              <p className="text-xs text-muted-foreground mt-1">Inverter a direção reordena os pontos e inverte as setas no mapa</p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <div>
                <span className="font-semibold text-sm text-muted-foreground">Total de Pontos:</span>
                <p className="text-base font-medium mt-1">
