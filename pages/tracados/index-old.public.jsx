...
import { CheckCircle2, Circle, Info, MapPin, Radio, Settings, ChevronLeft, ChevronRight, Plus, ExternalLink, Loader2, WifiOff, Wifi, X, List } from "lucide-react";
          ...
          <div className="flex-1 overflow-y-auto px-6 py-4">
            ...
            {currentStep === 0 && (
              <div className="space-y-4">
                ...
                <div>
                  <Label htmlFor="length" className="text-base">Comprimento Aproximado (metros)</Label>
                  <Input
                    id="length"
                    type="number"
                    placeholder="Ex: 4309"
                    ...
                    {devicesLoading ? (
                      ...
                      <div className="text-center py-8 space-y-4">
                        <div className="flex flex-col items-center gap-3">
                          ...
                          <div>
                            <p className="font-semibold text-lg">Nenhum dispositivo cadastrado</p>
                        ...
                        <CardContent className="pt-6">
                          <div className="flex items-start gap-3">
                            ...
                            <div className="text-sm text-blue-800 dark:text-blue-200">
                              <p className="font-semibold mb-1">Testando conexão GPS...</p>
                        ...
                        <CardContent className="pt-6">
                          <div className="flex items-start gap-3">
                            ...
                            <div className="text-sm text-green-800 dark:text-green-200">
                              <p className="font-semibold mb-1">✓ GPS Conectado!</p>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                      ...
                      <div className="text-center space-y-4">
                        <div className="relative">
                          ...
                          <div className="absolute inset-0 flex items-center justify-center">
                            <span className="text-2xl font-bold">{formData.points.length}</span>
                          </div>
                        </div>
                        <p className="text-lg font-semibold">Pontos capturados</p>
                        <p className="text-sm text-muted-foreground">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <Button 
                        variant={formData.trackingStatus === "tracking" ? "destructive" : "default"}
                        className="w-full"
                        onClick={() => {
                          if (formData.trackingStatus === "tracking") {
                            ...
                            setTimeout(() => updateFormData("points", [...formData.points, {lat: -23.5505, long: -46.6333}]), 1000);
                          }
                        }}
                      >
                        {formData.trackingStatus === "tracking" ? "⏸️ Pausar" : "▶️ Iniciar Rastreamento"}
                      </Button>
                      ...
                      <CardContent className="pt-6">
                        <div className="flex items-start gap-3">
                          ...
                          <div className="text-sm text-yellow-800 dark:text-yellow-200">
                            ...
                            <p>Mantenha velocidade constante e tente completar uma volta completa para melhor precisão.</p>
                          </div>
                        </div>
                      </CardContent>
                    </Card>
                  ...
                  <CardContent className="space-y-3">
                    <div className="grid grid-cols-2 gap-x-4 gap-y-3 text-sm">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground">{formData.length ? `${formData.length}m` : "-"}</p>
                      </div>
                      <div>
                        <span className="font-semibold">Dispositivo:</span>
                        <p className="text-muted-foreground">{formData.device || "-"}</p>
                      </div>
                      <div>
                      ...
                      <div>
                        <span className="font-semibold">Pontos Capturados:</span>
                        <p className="text-muted-foreground">{formData.points.length}</p>
                      </div>
                    </div>
